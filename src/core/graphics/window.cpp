...
// Set the viewport to the full window
    ...
    // called after draw
    void core::graphics::Window::render(){
        auto io = ImGui::GetIO();
    ...
    void core::graphics::Window::clear(Color color ){
        glClearColor(color.r, color.g ,color.b, color.a);
        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT | GL_STENCIL_BUFFER_BIT);
    }

    bool core::graphics::Window::is_open(){
        return !glfwWindowShouldClose(m_glfw_window);
    }

    void core::graphics::Window::close(){
        glfwSetWindowShouldClose(m_glfw_window, GLFW_TRUE);
    }

    void core::graphics::Window::resize(int width, int height){
        glfwSetWindowSize(m_glfw_window, width, height);
    }

    GLFWwindow* core::graphics::Window::get_glfw_window(){
        return m_glfw_window;
    }

    core::Vector2u core::graphics::Window::get_size(){
        int width, height;
        glfwGetFramebufferSize(m_glfw_window, &width, &height);
    ...
    core::Vector2f core::graphics::Window::get_mouse_pos(){
        double x, y;
    ...
    core::Vector2f core::graphics::Window::screen_to_world_pos(core::Vector2f screen_pos, bool top_left){ 
    ...
    void core::graphics::Window::glfw_error_callback(int error, const char* description){
        fmt::print("[ GLFW ERROR {} ] {}", error, description);
        endl();
    }

    void GLAPIENTRY core::graphics::Window::opengl_message_callback( 
                GLenum source,
                GLenum type,
                GLuint id,
                GLenum severity,
    ...
    bool core::graphics::Window::imgui_want_capture(core::Event event){
